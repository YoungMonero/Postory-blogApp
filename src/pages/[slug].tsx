...
import { getMyBlog, uploadBlogImage, updateMyBlog } from "@/src/services/blogs";
...
import BlogSettingsDrawer from "@/src/component/BlogSettingsDrawer";
...
const PostThumbnail = ({
    ...
    return (
      <img
        ...
        className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 ${
          isDraft || isArchived ? "opacity-70 grayscale-[30%]" : ""
        }`}
        alt={post.title}
      />
    );
  ...
  return (
    <div
      className={`w-full h-full bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 flex flex-col items-center justify-center p-6 text-center relative overflow-hidden group/thumb ${
        isDraft || isArchived ? "opacity-70 grayscale-[30%]" : ""
      }`}
    >
...
export default function BlogChannelView() {
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      await updateMyBlog({ [type]: uploaded.url }, token);
      ...
      if (type === "coverImage") setCoverPreview(null);
  ...
  const handleToggleVisibility = async (
    ...
    try {
      ...
      alert(
        `Post ${
          newStatus === "published" ? "published" : "moved to drafts"
      ...
      <Head>
        ...
        {(() => {
          ...
          const ogParams = new URLSearchParams({
            title: blog?.title || "My Wordoo Blog",
            author: userName || "Wordoo Creator",
            image: blog?.profileImage || "",
          }).toString();
          const dynamicOgUrl = `${baseUrl}/api/og?${ogParams}`;
          ...
          return (
            <>
              ...
              <meta
                property="og:title"
                content={blog?.title || "Blog Channel"}
              />
              <meta
              ...
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                <div className="max-w-3xl">
                  ...
                  <div className="flex items-center gap-4 mt-3 text-sm font-bold text-gray-400 uppercase tracking-widest">
                    ...
                    <div className="flex items-center gap-1.5">
                      <span className="text-gray-900">
                        {(blog?.subscriberCount || 0).toLocaleString()}
                      </span>
                      <span>
                        {(blog?.subscriberCount || 0) === 1
                          ? "Subscriber"
                          : "Subscribers"}
                      </span>
                    </div>
                  ...
                  <p className="mt-5 text-gray-500 text-lg leading-relaxed font-light">
                    {blog?.description ||
                      "Curating the finest insights and stories for the modern reader."}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  >
                    <ShareDropdown
                      ...
                      title={blog?.title || "My Blog on Wordoo"}
                      description={
                        blog?.description || "Check out my blog on Wordoo!"
                      }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {posts
                  ...
                  .map((post: any) => {
                    ...
                    const isArchived =
                      post.status?.toLowerCase() === "archived";
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <PostActionsDropdown
                            ...
                            onCopyLink={(postId, slug, title) =>
                              handleCopyLink(postId, slug, title)
                            }
                        ...
                        <div
                          onClick={() =>
                            !isArchived && router.push(destination)
                          }
                        >
