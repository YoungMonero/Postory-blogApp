                    ...
                    <div className="flex items-center gap-4">
                        {token ? (
                                ...
                                <div className="relative ml-2" ref={dropdownRef}>
                                    ...
                                    {isDropdownOpen && (
                                        <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                                            ...
                                            <div className="py-2">
                                                <Link href={blog ? `/${blog.slug}` : "/dashboard/create-blog"} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
                                                    {blog ? <ExternalLink size={18} /> : <PlusCircle size={18} />}
                            ...
                            <div className="flex items-center gap-3">
                                <Link href="/register">
                                    <Button
                                        className="bg-gray-900 hover:bg-indigo-600 text-white px-6 font-bold text-sm shadow-md shadow-gray-200/50 transition-all active:scale-95 flex items-center gap-2"
                                    >
                                        Sign Up
                                    </Button>
                                </Link>
